...
-- 3.9. Tạo bảng audit_logs trong system schema
...
CREATE INDEX IF NOT EXISTS idx_system_audit_logs_entity ON system.audit_logs(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_system_audit_logs_created ON system.audit_logs(created_at DESC);

COMMENT ON TABLE system.audit_logs IS 'Audit trail cho tất cả thay đổi trong hệ thống';
