"""Crawl TNPL với logic fixed - lấy definition từ thẻ p"""
import sys
import asyncio
...
async def main():
    ...
    # Cho phép chạy headed mode: python crawl_tnpl_fixed.py 730 --headed
    ...
    try:
        ...
        max_pages = MAX_PAGES or int(input("Số trang cần crawl: ") or "3")
        ...
        for page_num in range(1, max_pages + 1):
            try:
                ...
                await asyncio.sleep(2)  # Delay 2s như file cũ
            except Exception as e:
