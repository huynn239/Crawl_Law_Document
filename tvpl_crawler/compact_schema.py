...
def compact_schema(data):
    ...
    for item in data:
        ...
        exclude_keys = {"stt", "url", "title", "ngay_cap_nhat", "Ngay cap nhat", "tab4_relations", "tab4_summary", 
                       "tab4_total_relations", "tab8_links", "tab1_formulas", "tab1_total_formulas",
                       "_screenshot_before", "_screenshot_tab4", "_screenshot_tab8", "error"}
        ...
        compact_item = {
            ...
            "tab1": {
                "formulas": item.get("tab1_formulas", []),
                "total_formulas": item.get("tab1_total_formulas", 0)
            }
        }
